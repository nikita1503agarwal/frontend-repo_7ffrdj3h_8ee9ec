...
const work = [
  {
    ...
    desc: 'Built a creative testing engine and lifecycle pipeline that unlocked scale.',
    metrics: ['+318% revenue', 'CPAs -41%', 'AOV +22%']
  },
  {
    tag: 'SaaS',
    title: 'AetherCloud — 0→1 category launch',
    desc: 'Positioning, product story, and targeted demand gen to launch a new market.',
    metrics: ['8.3k signups', '6.1% MQL→SQL', 'CAC -27%']
  },
  {
    tag: 'Fintech',
    title: 'FluxPay — scaling responsibly',
    desc: 'Introduced risk-aware paid growth loops with creative velocity.',
    ...
    <section id="work" className="relative bg-black py-24">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-end justify-between gap-6">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-white">Selected systems</h2>
            <p className="mt-3 text-white/70 max-w-xl">Snapshots from compounding growth programs across categories.</p>
          </div>
