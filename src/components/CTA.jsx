  ...
  return (
    <section id="contact" className="relative bg-black py-24">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative">
        <h2 className="text-3xl md:text-4xl font-bold text-white">Ready to build a system that compounds?</h2>
        <p className="mt-4 text-white/70">
          Tell us about your goals. We’ll come back with a tailored plan, timeline, and how we’ll measure success.
        </p>
        <form className="mt-8 grid md:grid-cols-3 gap-3 text-left">
          ...
          <textarea placeholder="What are you trying to achieve?" rows="4" className="md:col-span-3 w-full rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-white/20"></textarea>
